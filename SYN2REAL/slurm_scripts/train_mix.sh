...
python train.py --domains "${final_train_domain[$SLURM_ARRAY_TASK_ID-1]}" --syn "${syn[$SLURM_ARRAY_TASK_ID-1]}" --mix True --model_path openai/whisper-small --configs configs/whisper_small.yaml;
